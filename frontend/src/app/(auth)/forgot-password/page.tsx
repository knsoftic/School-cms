 ...
 *
 * `auth.service.js` answers 200 whether or not the address is on file, and its header explains why:
    ...
    return (
      <AuthCard title="Check your email">
        <div className="mt-8 space-y-4">
          <Notice tone="success">
            If that address belongs to an account, a password reset link is on its way. The link
