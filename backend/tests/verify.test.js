 ...
 *
 * `tests/globalSetup.js` has already run all 40 suites serially and written `.last-run.json`. This
...
describe('harness integrity', () => {
  ...
  test('the run used the environment the baseline was recorded under', () => {
     ...
     * change what all 40 suites actually ran under — a different database, a different application
