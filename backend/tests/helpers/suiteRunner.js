 ...
 *
 * All 38 scripts call `process.exit()` when they finish, and none guards on `require.main`. A
 ...
 *
 *   1. **Exit code.** Reliable for a suite that ran, but 19 of the 38 catch a database-connect
 ...
 *
 * The line format is stable across 37 of the 38 scripts — `PASS` or `FAIL`, two spaces, the label,
